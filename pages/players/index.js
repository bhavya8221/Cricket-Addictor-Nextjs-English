...
import { PlayersAPI, playersAPI } from "../../Constants/Api/Api";
...
const Players = () => {
  ...
  //   const { router.asPath } = useLocation();
  ...
  useEffect(() => {
    ...
    playersAPI(25, alpha, playingRole, format)
      .then((res) => {
  ...
  }, [teamID, alpha, playingRole, format]);
  ...
  return (
    <>
      <Head>
        <title itemprop="name">
          All {teamName} cricket players, contracted players, profiles, stats,
          records, averages, photos & videos
        </title>
        <meta
          name="description"
          itemprop="description"
          content={`${teamName} cricket players, full details of India cricketers - profile, batting & averages, stats in India and abroad, full statistics, records and photos
          `}
        />
      ...
      <div className={styles.PlayersDisplay}>
        ...
        <div className={styles.PlayerBox}>
          <h5 style={{ fontSize: 18 }}>{teamName} Players</h5>
