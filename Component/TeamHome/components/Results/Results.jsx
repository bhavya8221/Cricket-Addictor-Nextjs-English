...
const Results = () => {
  ...
  const [allTeamWiseData, setAllTeamWiseData] = useState([]);
  ...
  useEffect(() => {
    ...
    teamWiseMatchListAPI(tid, "Completed", page, PER_PAGE)
      .then((res) => {
  ...
  return (
    <div className={styles.Results}>
      <Head>
        {/* <title>India National Cricket Team Results</title> */}

        <link rel="canonical" href={currentPageUrl} />
        {prevPageUrl && <link rel="prev" href={prevPageUrl} />}
        {nextPageUrl && <link rel="next" href={nextPageUrl} />}
      </Head>
      {teamWiseCompletedMatch &&
