      ...
      <div className="Tname">
        ...
        <div className="rightcol">
          {Object.keys(teamStatsData).length === 0 ? (
            ...
            <>
              <div className="MatchConditionList">
                <div
                ...
                <div
                  ...
                  style={{
                    ...
                    color: matchCondition === "year" ? "var(--primary)" : "unset",
                  }}
              ...
              <Row className="MatchTypeConditionRowStats Heading">
                <Col className="MatchTypeCondition">
                  <div
                    className="MatchType"
                    style={{
              ...
              {Object.keys(teamStatsData).length === 0 ? (
                <div style={{ margin: "10px", textAlign: "center" }}>
                  <h4>Batting Performance data not available ...</h4>
                </div>
              ) : (
                  ...
                  <table className="table  table-borderless">
                    ...
                    <tbody>
                      {Object.keys(teamStatsData).map((item, index) => {
                        return (
                          <tr key={index}>
                            <th className="row TeamItem">{item}</th>
